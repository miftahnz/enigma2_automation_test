...
//		WebUI.comment("Start Login Before Run Test Case Registration")
...
//	 */
//	@AfterTestCase
//	def closeBrowserIfFailed(TestCaseContext testCaseContext) {
//		if (testCaseContext.getTestCaseStatus() == "FAILED") {
//			WebUI.comment("Test Case Failed, Menutup Browser...")
//			WebUI.closeBrowser()
//		}
//	}
